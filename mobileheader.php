...
<body>
    ...
    <div class="wrapper">
        <!-- Sidebar Holder -->
        <nav id="sidebar" style="background-color:rgb(41, 37, 36);z-index: 999; ">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active " >
                    ...
                    <ul class="collapse list-unstyled " id="homeSubmenu">
                        ...
                        <li>
                            <a href="canceled.php">Cancelled</a>
                        </li>
                        <li>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #3d3023;  z-index: 999;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item btn ">
                                <a class="nav-link" href="headeraccount.php"><i class="fas fa-toggle-on"></i></a>
                            </li>
                            <li class="nav-item btn ">
